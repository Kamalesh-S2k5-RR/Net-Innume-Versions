...
class DashboardWindow:
    ...
    def show_about_popup(self):
        ...
        ctk.CTkLabel(about_win, text="v1.4 Core | Llama-3 AI Engine", font=("Arial", 10), text_color=("#555555", "#888888")).pack(pady=(0, 15))
    ...
    def share_app(self):
        ...
        repo_link = "https://www.mediafire.com/file/yv0475mx1mklu4x/Net_Immune_Setup_current.exe/file" 
