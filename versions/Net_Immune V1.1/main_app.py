...
class DashboardWindow:
    ...
    def show_tutorial_popup(self):
        ...
        agents = [
            ("⚡ Hotkey:", "Highlight text and press Caps Lock to scan."),
    ...
    def build_main_frame(self):
        ...
        self.create_agent_toggle(self.main_frame, "⚡ Hotkey Scanner ( caps lock )", 1)
    ...
    def show_about_popup(self):
        ...
        ctk.CTkLabel(about_win, text="v1.1 Core | Llama-3 AI Engine", font=("Arial", 10), text_color=("#555555", "#888888")).pack(pady=(0, 15))
...
class FloatingMascot:
    def __init__(self, root):
        ...
        try: keyboard.add_hotkey('caps lock', self.trigger_caps_scan, suppress=True)
        except: pass
    ...
    def trigger_caps_scan(self, event=None):
        ...
        self.log_to_dashboard("> [Hotkey] Caps Lock pressed! Grabbing text...")
